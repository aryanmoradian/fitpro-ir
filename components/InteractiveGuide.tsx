...
const tourSteps: GuideStep[] = [
    ...
    },
    {
        ...
        title: 'تحلیل زیستی',
        content: 'با تحلیل‌های زیستی، عمیق‌تر به عملکرد خود بپردازید. اگر اولین بارتان است، یک راهنما به شما در درک و وارد کردن داده‌های بیومتریک مانند VO2 Max و تاریخچه هورمونی کمک می‌کند.',
        view: AppView.BIOLOGICAL_ANALYSIS,
    },
    {
